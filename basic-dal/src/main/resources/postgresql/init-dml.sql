...
INSERT INTO t_cache_def(id,cache_name,app_name,cache_zk_path,cache_redis_key,cache_ins_class,is_global,is_durable,
duration_of_minutes,last_load_datetime,status,update_user_id,create_user_id,update_datetime,create_datetime) values (
nextval('SEQ_CACHE_DEF'),'cache_def','basic-service','/cache/refresh/cache_def','cache::basic::cache_def',
'org.cuber.stub.basic.CacheDef','Y','N',null,null,'1','1','1',current_timestamp, current_timestamp);

INSERT INTO t_cache_def(id,cache_name,app_name,cache_zk_path,cache_redis_key,cache_ins_class,is_global,is_durable,
duration_of_minutes,last_load_datetime,status,update_user_id,create_user_id,update_datetime,create_datetime) values (
nextval('SEQ_CACHE_DEF'),'app_def','basic-service','/cache/refresh/app_def','cache::basic::app_def',
'org.cuber.stub.basic.AppDef','Y','N',null,null,'1','1','1',current_timestamp, current_timestamp);

INSERT INTO t_cache_def(id,cache_name,app_name,cache_zk_path,cache_redis_key,cache_ins_class,is_global,is_durable,
duration_of_minutes,last_load_datetime,status,update_user_id,create_user_id,update_datetime,create_datetime) values (
nextval('SEQ_CACHE_DEF'),'biz_table_def','basic-service','/cache/refresh/biz_table_def','cache::basic::biz_table_def',
'org.cuber.stub.basic.BizTableDef','Y','N',null,null,'1','1','1',current_timestamp, current_timestamp);

INSERT INTO t_cache_def(id,cache_name,app_name,cache_zk_path,cache_redis_key,cache_ins_class,is_global,is_durable,
duration_of_minutes,last_load_datetime,status,update_user_id,create_user_id,update_datetime,create_datetime) values (
nextval('SEQ_CACHE_DEF'),'country','basic-service','/cache/refresh/country','cache::basic::country',
'org.cuber.stub.basic.Country','Y','N',null,null,'1','1','1',current_timestamp, current_timestamp);

INSERT INTO t_cache_def(id,cache_name,app_name,cache_zk_path,cache_redis_key,cache_ins_class,is_global,is_durable,
duration_of_minutes,last_load_datetime,status,update_user_id,create_user_id,update_datetime,create_datetime) values (
nextval('SEQ_CACHE_DEF'),'currency','basic-service','/cache/refresh/currency','cache::basic::currency',
'org.cuber.stub.basic.Currency','Y','N',null,null,'1','1','1',current_timestamp, current_timestamp);

INSERT INTO t_cache_def(id,cache_name,app_name,cache_zk_path,cache_redis_key,cache_ins_class,is_global,is_durable,
duration_of_minutes,last_load_datetime,status,update_user_id,create_user_id,update_datetime,create_datetime) values (
nextval('SEQ_CACHE_DEF'),'dictionary','basic-service','/cache/refresh/dictionary','cache::basic::dictionary',
'org.cuber.stub.basic.Dictionary','Y','N',null,null,'1','1','1',current_timestamp, current_timestamp);
